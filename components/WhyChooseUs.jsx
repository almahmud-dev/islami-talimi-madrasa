...
const reasons = [
  {
    icon: "/images/why-choose-us/islamic-education.png",
  ...
  {
    icon: "/images/why-choose-us/modern-education.png",
  ...
  {
    icon: "/images/why-choose-us/experienced-teacher.png",
  ...
  {
    icon: "/images/why-choose-us/modern-learning.png",
    title: "আধুনিক ও ইসলামী শিক্ষার সমন্বয়:",
    description:
      "আমরা ইসলামী শিক্ষার পাশাপাশি আধুনিক শিক্ষার সুযোগ প্রদান করি, যা ছাত্রদের যুগের সাথে মানানসই দক্ষতা অর্জনে সহায়তা করে।",
  },
  {
    icon: "/images/why-choose-us/dedicated-teachers.png",
    title: "প্রশিক্ষিত ও অভিজ্ঞ শিক্ষকবৃন্দ:",
    description:
      "আমাদের শিক্ষকরা অভিজ্ঞ, এবং তারা ছাত্রদের মানসিক ও আধ্যাত্মিক উন্নতির প্রতি মনোযোগ দেন।",
  },
  {
    icon: "/images/why-choose-us/safe-environment.png",
    title: "মানসম্মত শিক্ষার পরিবেশ:",
    description:
      "একটি মনোরম, নিরাপদ ও শিক্ষাবান্ধব পরিবেশে ছাত্রদের গড়ে তোলার জন্য আমরা বদ্ধপরিকর।",
  },
  {
    icon: "/images/why-choose-us/physical-activity.png",
    title: "শরীরচর্চা ও খেলাধুলা",
    description:
      "আমরা ছাত্রদেরকে কুরআন, হাদিস এবং ইসলামী আইন শাস্ত্রের বিশুদ্ধ জ্ঞান প্রদান করি, যা তাদের আখিরাত ও দুনিয়া উভয়ের জন্য উপকারী।",
  },
  {
    icon: "/images/why-choose-us/mental-health.png",
    title: "শিক্ষার্থীদের শারীরিক ও মানসিক স্বাস্থ্য",
    description:
      "আমরা ইসলামী শিক্ষার পাশাপাশি আধুনিক শিক্ষার সুযোগ প্রদান করি, যা ছাত্রদের যুগের সাথে মানানসই দক্ষতা অর্জনে সহায়তা করে।",
  },
  {
    icon: "/images/why-choose-us/security.png",
    title: "শিক্ষার্থীদের সুরক্ষায় সার্বক্ষণিক নজরদারি",
    description:
      "আমাদের শিক্ষকরা অভিজ্ঞ, এবং তারা ছাত্রদের মানসিক ও আধ্যাত্মিক উন্নতির প্রতি মনোযোগ দেন।",
  },
  {
    icon: "/images/why-choose-us/talent-development.png",
    ...
    >
      <Container>
        ...
        <div className="mx-auto mb-10 max-w-4xl text-center sm:mb-12">
          ...
          <p className="mt-8 text-sm leading-7 text-[#666] sm:text-[15px] sm:leading-8">
            ...
            {reasons.map((reason, index) => {
              ...
              return (
                ...
                >
                  ...
                  {/* Title */}
                  <h3 className="mb-3 text-[15px] font-semibold leading-6 text-[#4a4a4a] sm:text-base">
                    {reason.title}
                  </h3>

                  {/* Description */}
                  <p className="max-w-[255px] text-[13px] leading-6 text-[#777]">
                    {reason.description}
                  </p>
                </article>
              );
