...
const WhyChooseUs = () => (
  <section
    ...
    className="bg-[#f8fbf9] py-14 sm:py-20 lg:py-24"
  >
    <Container>
      <div className="mx-auto mb-10 max-w-3xl text-center sm:mb-14 lg:mb-16">
        <p className="mb-3 text-sm font-semibold tracking-[0.18em] text-[#0e7a3e] sm:text-base">
          কেন আমাদের মাদ্রাসা বেছে নেবেন
        </p>
        <h2
        ...
        <p className="mx-auto mt-5 max-w-2xl text-base leading-8 text-[#5d6d65] sm:text-lg">
          দ্বীনি শিক্ষা, আধুনিক জ্ঞান ও নৈতিক চরিত্র গঠনের সমন্বয়ে আমরা তৈরি করি
          একটি নিরাপদ ও আদর্শ শিক্ষার পরিবেশ। আমাদের লক্ষ্য শুধু ভালো ফলাফল নয়,
          বরং আপনার সন্তানকে জ্ঞানী, নৈতিক ও দায়িত্বশীল মানুষ হিসেবে গড়ে তোলা।
        </p>
      </div>
      ...
      <div className="grid grid-cols-1  gap-5 sm:grid-cols-2 lg:grid-cols-3 lg:gap-5">
        {reasons.map((reason) => (
          <article
            key={reason.icon}
            className="group relative isolate min-h-[260px] overflow-hidden rounded-3xl border border-[#dcebe2] bg-white p-5 shadow-[0_8px_24px_rgba(14,122,62,0.06)] transition-all duration-500 ease-out will-change-transform hover:-translate-y-2 hover:scale-[1.015] hover:border-[#b5d9c2] hover:shadow-[0_18px_38px_rgba(14,122,62,0.15)] sm:p-6"
          >
            <Image
              src={CardBanner}
              alt=""
              ...
              className="pointer-events-none z-0 object-cover object-center opacity-[0.8]  "
            />
            <div className="relative z-10 grid grid-cols-[72px_minmax(0,1fr)] items-center gap-4 sm:grid-cols-[88px_minmax(0,1fr)] sm:gap-5 h-full items-center">
              ...
              <div className="min-w-0">
                <h3 className="mb-2 text-lg font-bold leading-7 text-[#174c37] transition-colors duration-300 group-hover:text-[#0e7a3e] sm:text-xl sm:leading-8">
                  {reason.title}
                </h3>
                <p className="text-sm leading-6 text-[#63746b] sm:text-base sm:leading-7">
                  {reason.description}
                </p>
              </div>
            </div>
