...
const sectionTitle = "অভিভাবক ও শিক্ষার্থীরা আমাদের সম্পর্কে কী বলছেন?";
const sectionDescription =
  "আমাদের শিক্ষা পরিবেশ, যত্নশীল শিক্ষকতা ও নৈতিক দিকনির্দেশনা সম্পর্কে শিক্ষার্থী ও অভিভাবকদের বাস্তব মতামত জানুন।";
    ...
    <section className="relative isolate overflow-hidden bg-white py-14 sm:py-20">
      ...
      <Container className="relative max-w-6xl">
        <div className="mx-auto max-w-xl text-center">
          ...
          <h2 className="mx-auto max-w-[450px] text-3xl font-bold leading-tight text-[#174c37] sm:text-4xl lg:text-[42px]">
            {sectionTitle}
          </h2>
          <p className="mx-auto mt-4 max-w-2xl text-base leading-8 text-[#5d6d65] sm:text-lg">
            {sectionDescription}
          </p>
        </div>
